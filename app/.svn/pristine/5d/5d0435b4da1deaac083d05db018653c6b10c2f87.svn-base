...
public class ActionButton extends View {
	...
	private void initButtonColorPressed(TypedArray attrs) {
		int index = styleable.ActionButton_button_colorPressed;
		if (attrs.hasValue(index)) {
	...
	private void initRippleEffectEnabled(TypedArray attrs) {
		int index = styleable.ActionButton_rippleEffect_enabled;
		if (attrs.hasValue(index)) {
	...
	public enum Animations {
		 ...
		 * Fade in animation 
		 */
		FADE_IN             (anim.fab_fade_in),

		/**
		 * Fade out animation 
		 */
		FADE_OUT            (anim.fab_fade_out),

		/**
		 * Scale up animation 
		 */
		SCALE_UP            (anim.fab_scale_up),

		/**
		 * Scale down animation 
		 */
		SCALE_DOWN          (anim.fab_scale_down),

		/**
		 * Roll from down animation 
		 */
		ROLL_FROM_DOWN      (anim.fab_roll_from_down),

		/**
		 * Roll to down animation 
		 */
		ROLL_TO_DOWN        (anim.fab_roll_to_down),

		/**
		 * Roll from right animation 
		 */
		ROLL_FROM_RIGHT     (anim.fab_roll_from_right),

		/**
		 * Roll to right animation 
		 */
		ROLL_TO_RIGHT       (anim.fab_roll_to_right),

		/**
		 * Jump from down animation 
		 */
		JUMP_FROM_DOWN      (anim.fab_jump_from_down),

		/**
		 * Jump to down animation 
		 */
		JUMP_TO_DOWN        (anim.fab_jump_to_down),

		/**
		 * Jump from right animation 
		 */
		JUMP_FROM_RIGHT     (anim.fab_jump_from_right),

		/**
		 * Jump to right animation 
		 */
		JUMP_TO_RIGHT       (anim.fab_jump_to_right);
